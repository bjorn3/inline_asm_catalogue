* Authors: Daan Sprenkels
* Reason: timing-critical code
* Language: C
* Source: https://github.com/dsprenkels/ws2812b_attiny13/blob/master/ws2812b_attiny13.c
* License: [MIT](https://github.com/dsprenkels/ws2812b_attiny13/blob/master/LICENSE)

# Code

This assembly snippet implements a driver for the [WS2812B] RGB led for the
[ATTiny13A] microcontroller. To communicate with the LED color, the
ATTiny13A sends pulses of 400 ns (logical 0) or 800 ns (logical 1).  To
achieve this, we need to control how the instructions are scheduled and insert
the relevent nop instructions (`nop` for 1 cycles; `rjmp .+0` for 2 cycles)
where needed.
